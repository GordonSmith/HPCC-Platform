...
# Fix GCC 16 constexpr function pointer comparison issue
file(READ "${SOURCE_PATH}/absl/container/internal/hash_policy_traits.h" _content)
string(REPLACE 
...
string(REPLACE 
    ...
    "#pragma GCC diagnostic pop\n#endif\n#endif\n  }"
    _content "${_content}")
file(WRITE "${SOURCE_PATH}/absl/container/internal/hash_policy_traits.h" "${_content}")
