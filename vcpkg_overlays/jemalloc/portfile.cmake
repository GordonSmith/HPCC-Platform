...
# Fix GCC 16 compatibility: std::__throw_bad_alloc doesn't exist
file(READ "${SOURCE_PATH}/src/jemalloc_cpp.cpp" _content)
string(REPLACE 
    "std::__throw_bad_alloc();"
    "throw std::bad_alloc();"
    _content "${_content}")
file(WRITE "${SOURCE_PATH}/src/jemalloc_cpp.cpp" "${_content}")
