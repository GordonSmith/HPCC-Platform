...
# Fix realpath -s not supported on all systems
file(READ "${SOURCE_PATH}/configure" _content)
string(REPLACE 
    "realpath -s"
    "realpath"
    _content "${_content}")
file(WRITE "${SOURCE_PATH}/configure" "${_content}")
...
set(ENV{LDFLAGS} "$ENV{LDFLAGS} -lc")
