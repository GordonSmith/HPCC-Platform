...
#if defined(__arm__) || defined(__thumb__) || defined(_M_ARM) || defined(_M_ARMT) || defined(__TARGET_ARCH_ARM) || defined(__TARGET_ARCH_THUMB)
#define _ARCH_ARM32_
#endif
...
#if defined(__powerpc__) || defined(__powerpc64__) || defined(__ppc__) || defined(__ppc64__) || defined(__ppc64el__)
...
{
  return islower((int)(unsigned char)(c));
}
...
{
  return ispunct((int)(unsigned char)(c));
}
...
{
  return isprint((int)(unsigned char)(c));
}

#undef isgraph
inline bool isgraph(char c)
{
  return isgraph((int)(unsigned char)(c));
}

#undef iscntrl
inline bool iscntrl(char c)
{
  return iscntrl((int)(unsigned char)(c));
}
...
// Region: **** START OF EMSCRIPTEN SPECIFIC SECTION ****
#define strnicmp strncasecmp
#define INFINITE 0xFFFFFFFF
// **** END   OF EMSCRIPTEN SPECIFIC SECTION ****
#else
#undef __BYTE_ORDER
