...
namespace cmcpp
{
    ...
    using HostUnicodeConversion = std::function<std::pair<char8_t *, size_t>(char8_t *dest, uint32_t dest_byte_len, const char8_t *src, uint32_t src_byte_len, Encoding from_encoding, Encoding to_encoding)>;
