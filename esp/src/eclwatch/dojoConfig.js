...
function getConfig(env) {
    ...
    return {
        ...
        paths: {
            ...
            "@hpcc-js/api": baseUrl + "/node_modules/@hpcc-js/api/build/api",
            "@hpcc-js/chart": baseUrl + "/node_modules/@hpcc-js/chart/build/chart",
            "@hpcc-js/common": baseUrl + "/node_modules/@hpcc-js/common/build/common",
            "@hpcc-js/comms": baseUrl + "/node_modules/@hpcc-js/comms/build/comms",
            "@hpcc-js/composite": baseUrl + "/node_modules/@hpcc-js/composite/build/composite",
            "@hpcc-js/form": baseUrl + "/node_modules/@hpcc-js/form/build/form",
            "@hpcc-js/graph": baseUrl + "/node_modules/@hpcc-js/graph/build/graph",
            "@hpcc-js/layout": baseUrl + "/node_modules/@hpcc-js/layout/build/layout",
            "@hpcc-js/map": baseUrl + "/node_modules/@hpcc-js/map/build/map",
            "@hpcc-js/other": baseUrl + "/node_modules/@hpcc-js/other/build/other",
            "@hpcc-js/util": baseUrl + "/node_modules/@hpcc-js/util/build/util",
            "@hpcc-js/TopoJSON": dojoRoot ? "/esp/files/build/TopoJSON" : baseUrl + "/node_modules/@hpcc-js/map/TopoJSON",
            ...
            "topojson": baseUrl + "/node_modules/topojson/",
