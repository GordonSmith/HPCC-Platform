...
], function (declare, lang, i18n, nlsHPCC, arrayUtil, Deferred, domStyle, Evented,
            ...
            callback(declare([Evented], {
                ...
                centerOnItem: function (item, scaleToFit, widthOnly) {
                    ...
                    if (scaleToFit) {
                        ...
                        this.graphWidget.shrinkToFit(bounds);//, this.graphWidget._transitionDuration);
                    } else {
                        this.graphWidget.centerOn(bounds);//, this.graphWidget._transitionDuration);
                    }
                },
                ...
                getSVG: function () {
                    return "";//this.graphWidget.graphData.getJSON();
                },
        ...
        resize: function (size) {
            ...
            if (this.hasPlugin()) {
                this._plugin.graphWidget
                    ...
                    .render()
                ;
                var width = this._plugin.graphWidget.width();
                var height = this._plugin.graphWidget.height();
            }
        },
