...
let rewrite = [
    ...
    { from: "/esp/files/dist/(.*)", to: "/packages/eclwatch-dojo/build/dist/$1" },
    { from: "/esp/files/img/(.*)", to: "/packages/eclwatch-dojo/build/esp/files/img/$1" },
    { from: "/esp/files/(.*/*.css)", to: "/packages/eclwatch-dojo/build/esp/files/$1" },
    { from: "/esp/files/(.*)", to: "/packages/eclwatch-dojo/build/$1" },
