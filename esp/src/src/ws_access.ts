...
var UsersStore = dojoDeclare([ESPRequest.Store], {
    service: "ws_access",
    action: "UserQuery",
...
var GroupsStore = dojoDeclare([ESPRequest.Store], {
    service: "ws_access",
    action: "GroupQuery",
...
var CONCAT_SYMBOL = ":";
var ResourcesStore = dojoDeclare([Memory], {
...
var InheritedPermissionStore = dojoDeclare([Memory], {
...
var AccountResourcesStore = dojoDeclare([Memory], {
...
var IndividualPermissionsStore = dojoDeclare([Memory], {
...
var PermissionsStore = dojoDeclare([Memory], {
    service: "ws_access",
    action: "Permissions",
