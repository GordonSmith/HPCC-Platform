...
// // export * as Deferred from "dojo/_base/Deferred";  // Base Deferred
// // export * as arrayUtil from "dojo/_base/array";
// // export * as config from "dojo/_base/config";
// // export * as lang from "dojo/_base/lang";
// // export * as aspect from "dojo/aspect";
// // export * as cookie from "dojo/cookie";
// // export * as DeferredFull from "dojo/Deferred";    // Full Deferred (rarely used)
// // export * as dom from "dojo/dom";
// // export * as domClass from "dojo/dom-class";
// // export * as domConstruct from "dojo/dom-construct";
// // export * as domForm from "dojo/dom-form";
...
// // export * as Evented from "dojo/Evented";
// // export * as has from "dojo/has";
// // export * as html from "dojo/html";
// // export * as json from "dojo/json";
// // export * as mouse from "dojo/mouse";
// // export * as parser from "dojo/parser";
// // export * as all from "dojo/promise/all";
// // export * as query from "dojo/query";
// // export * as request from "dojo/request";
// // export * as iframe from "dojo/request/iframe";
// // export * as script from "dojo/request/script";
// // export * as xhr from "dojo/request/xhr";
// // export * as Stateful from "dojo/Stateful";
// // export * as Observable from "dojo/store/Observable";
// // export * as QueryResults from "dojo/store/util/QueryResults";
// // export * as SimpleQueryEngine from "dojo/store/util/SimpleQueryEngine";
// // export * as topic from "dojo/topic";

// import * as dijitMain from "dijit/main";
// export const Menu = dijitMain.Menu;
// export const MenuItem = dijitMain.MenuItem;
// export const MenuSeparator = dijitMain.MenuSeparator;
// export const dijitRegistry = dijitMain.registry;
// export const Tooltip = dijitMain.Tooltip;
// export const CheckedMenuItem = dijitMain.CheckedMenuItem;

// // export * as Menu from "dijit/Menu";
// // export * as MenuItem from "dijit/MenuItem";
// // export * as MenuSeparator from "dijit/MenuSeparator";
// // export * as dijitRegistry from "dijit/registry";
// // export * as Tooltip from "dijit/Tooltip";
// // // export * as CheckedMenuItem from "dijit/CheckedMenuItem";

// export * as dojoxXmlParser from "dojox/xml/parser";
// export * as dojoxHtmlEntities from "dojox/html/entities"; // encoding helpers
...
// // @ts-expect-error
// export * as hpcc_Widget from "hpcc/_Widget";
// // @ts-expect-error
// export * as hpcc_TabContainerWidget from "hpcc/_TabContainerWidget";
// // @ts-expect-error
// export * as hpcc_DelayLoadWidget from "hpcc/DelayLoadWidget";

// // Side-effect HPCC widgets (template usage / registration)
// // import "dijit/Dialog";
// // import "dijit/form/Button";
// // import "dijit/form/DropDownButton";
// // import "dijit/form/NumberSpinner";
