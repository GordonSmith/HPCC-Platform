...
const routes: Routes = [
    ...
    //  ECL  ---
    {
        ...
        children: [
            ...
            { path: "/:Wuid/:Tab", action: (ctx, params) => import("./components/WorkunitDetails").then(_ => <_.WorkunitDetails wuid={params.Wuid as string} tab={params.Tab as string} filter={parseSearch(ctx.search) as any} />) },
