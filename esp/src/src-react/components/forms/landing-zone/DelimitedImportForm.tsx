...
type DelimitedImportFormValues = {
    destGroup: string;
...
export const DelimitedImportForm: React.FunctionComponent<DelimitedImportFormProps> = ({
    ...
    const { handleSubmit, control, register, reset } = useForm<DelimitedImportFormValues>({ defaultValues });
        ...
        <div className={componentStyles.body}>
            ...
            <Stack>
                <table><tbody>
                    ...
                    <tr>
                        <td><Controller
                            control={control} name="sourceCsvQuote" defaultValue=""
                            render={({
                                field: { onChange, name: fieldName, value },
                                fieldState: { error }
                            }) => <TextField
                        ...
                        /></td>
                        <td><Controller
                            control={control} name="sourceCsvEscape" defaultValue=""
                            render={({
                                field: { onChange, name: fieldName, value },
                                fieldState: { error }
                            }) => <TextField
